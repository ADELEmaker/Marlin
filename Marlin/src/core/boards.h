...
#define BOARD_TENLOG_MB1_V23          1158  // Tenlog D3, D5, D6 IDEX Printer
#define BOARD_RAMPS_S_12_EEFB         1159  // Ramps S 1.2 by Sakul.cz (Power outputs: Hotend0, Hotend1, Fan, Bed)
#define BOARD_RAMPS_S_12_EEEB         1160  // Ramps S 1.2 by Sakul.cz (Power outputs: Hotend0, Hotend1, Hotend2, Bed)
#define BOARD_RAMPS_S_12_EFFB         1161  // Ramps S 1.2 by Sakul.cz (Power outputs: Hotend, Fan0, Fan1, Bed)
#define BOARD_LONGER3D_LK1_PRO        1162  // Longer LK1 PRO / Alfawise U20 Pro (PRO version)
#define BOARD_LONGER3D_LKx_PRO        1163  // Longer LKx PRO / Alfawise Uxx Pro (PRO version)
#define BOARD_ZRIB_V53                1164  // Zonestar zrib V5.3 (Chinese RAMPS replica)
#define BOARD_PXMALION_CORE_I3        1165  // Pxmalion Core I3
#define BOARD_PANOWIN_CUTLASS         1166  // Panowin Cutlass (as found in the Panowin F1)
#define BOARD_KODAMA_BARDO            1167  // Kodama Bardo V1.x (as found in the Kodama Trinus)
