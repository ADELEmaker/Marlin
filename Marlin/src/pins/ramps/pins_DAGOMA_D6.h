...
// Alter timing for graphical display
   ...
   */
  #define X_SERIAL_RX_PIN                     73  // PJ3
  #define X_SERIAL_TX_PIN                     73  // PJ3
  #define Y_SERIAL_RX_PIN                     73  // PJ3
  #define Y_SERIAL_TX_PIN                     73  // PJ3
  #define Z_SERIAL_RX_PIN                     73  // PJ3
  #define Z_SERIAL_TX_PIN                     73  // PJ3
  #define E0_SERIAL_RX_PIN                    73  // PJ3
  #define E0_SERIAL_TX_PIN                    73  // PJ3
